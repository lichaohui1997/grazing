...
%% Europe Niche
cond1_pr = (aggregate_pr >= 349 & aggregate_pr <= 3574);
cond1_tas = (aggregate_tas >= 1.3 & aggregate_tas <= 17);
cond1_sfcWind = (aggregate_sfcWind >= 2.2 & aggregate_sfcWind <= 17);
cond_hurs = (aggregate_hurs >= 55 & aggregate_hurs <= 68);
...
turnover_Europe_rcp26_average=sum(sum(compare_turnover_rcp26_average(Europemask==1)));
turnover_increase_Europe_rcp26_average=sum(sum(turnover_increase_rcp26_average((Europemask==1))))
turnover_decrease_Europe_rcp26_average=sum(sum(turnover_decrease_rcp26_average((Europemask==1))))

%% Batch making for all continents and all rcps
% Define RCPs and Continents
rcps = {'rcp26', 'rcp45', 'rcp60', 'rcp85'};
continents = {'Asia', 'Europe', 'Oceania', 'Europe', 'NorthAmerica', 'SouthAmerica'};
...
%save('./grazingniche/matdata/turnover_continents_average.mat','turnover_decrease_Europe_rcp26_average')
%% Creat figures
...
% Data for turnover
data = [
    turnover_continents_average.Europe.rcp26.increase, turnover_continents_average.Europe.rcp26.decrease;
    turnover_continents_average.Europe.rcp45.increase, turnover_continents_average.Europe.rcp45.decrease;
    turnover_continents_average.Europe.rcp60.increase, turnover_continents_average.Europe.rcp60.decrease;
    turnover_continents_average.Europe.rcp85.increase, turnover_continents_average.Europe.rcp85.decrease
];
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_bar_Europe.svg');
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_Europe.svg');
%close all;
save('./grazingniche/matdata/turnover_average_Europe.mat','compare_turnover_rcp26_average','compare_turnover_rcp45_average','compare_turnover_rcp60_average','compare_turnover_rcp85_average');     
