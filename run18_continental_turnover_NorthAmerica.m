...
NorthAmerica = {'m_ARG', 'm_BOL', 'm_BRA', 'm_CHL', 'm_COL', 'm_ECU', 'm_GUY', 'm_PRY', 'm_PER', 'm_SUR', 'm_URY', 'm_VEN'};
SouthAmericamask = country_data.m_ARG;
for i = 2:length(NorthAmerica)
    SouthAmericamask = SouthAmericamask + country_data.(NorthAmerica{i});
end
...
colorbar
% NorthAmerica
NorthAmerica = {'m_DZA', 'm_COD','m_SDN', 'm_AGO', 'm_BEN', 'm_BWA', 'm_BFA', 'm_BDI', 'm_CMR', 'm_CPV', 'm_CAF', 'm_TCD', 'm_COM', 'm_COG', 'm_CIV', 'm_DJI', 'm_EGY', 'm_GNQ', 'm_ERI', 'm_ETH', 'm_GAB', 'm_GMB', 'm_GHA', 'm_GIN', 'm_GNB', 'm_KEN', 'm_LSO', 'm_LBR', 'm_LBY', 'm_MDG', 'm_MWI', 'm_MLI', 'm_MRT', 'm_MUS', 'm_MAR', 'm_MOZ', 'm_NAM', 'm_NER', 'm_NGA', 'm_REU', 'm_RWA', 'm_STP', 'm_SEN', 'm_SLE', 'm_SOM', 'm_ZAF', 'm_SSD', 'm_ESH', 'm_SWZ', 'm_TZA', 'm_TGO', 'm_TUN', 'm_UGA', 'm_ZMB', 'm_ZWE'};
Africamask = country_data.m_DZA;
for i = 2:length(NorthAmerica)
    Africamask = Africamask + country_data.(NorthAmerica{i});
end
imagesc(Africamask)
colorbar
...
% NorthAmerica
NorthAmerica = {'m_AUS', 'm_FJI', 'm_KIR', 'm_FSM', 'm_NCL', 'm_NZL', 'm_NIU', 'm_PLW', 'm_PNG', 'm_WSM', 'm_SLB', 'm_TON', 'm_VUT'};

NorthAmericamask = country_data.m_AUS;
for i = 2:length(NorthAmerica)
    NorthAmericamask = NorthAmericamask + country_data.(NorthAmerica{i});
end
imagesc(NorthAmericamask)
...
NorthAmericamask = NorthAmericamask(:, [ceil(end/2+1):end, 1:floor(end/2)]);
...
%% Africa Niche
cond1_pr = (aggregate_pr >= 228 & aggregate_pr <= 1889);
cond1_tas = (aggregate_tas >= 3.1 & aggregate_tas <= 26);
cond1_sfcWind = (aggregate_sfcWind >= 1.2 & aggregate_sfcWind <= 5.3);
cond_hurs = (aggregate_hurs >= 43 & aggregate_hurs <= 63);
...
turnover_NorthAmerica_rcp26_average=sum(sum(compare_turnover_rcp26_average(Africamask==1)));
turnover_increase_NorthAmerica_rcp26_average=sum(sum(turnover_increase_rcp26_average((Africamask==1))))
turnover_decrease_NorthAmerica_rcp26_average=sum(sum(turnover_decrease_rcp26_average((Africamask==1))))

%% Batch making for all continents and all rcps
% Define RCPs and Continents
rcps = {'rcp26', 'rcp45', 'rcp60', 'rcp85'};
continents = {'Asia', 'Europe', 'NorthAmerica', 'NorthAmerica', 'NorthAmerica', 'NorthAmerica'};
...
%save('./grazingniche/matdata/turnover_continents_average.mat','turnover_decrease_NorthAmerica_rcp26_average')
%% Creat figures
...
% Data for turnover
data = [
    turnover_continents_average.NorthAmerica.rcp26.increase, turnover_continents_average.NorthAmerica.rcp26.decrease;
    turnover_continents_average.NorthAmerica.rcp45.increase, turnover_continents_average.NorthAmerica.rcp45.decrease;
    turnover_continents_average.NorthAmerica.rcp60.increase, turnover_continents_average.NorthAmerica.rcp60.decrease;
    turnover_continents_average.NorthAmerica.rcp85.increase, turnover_continents_average.NorthAmerica.rcp85.decrease
];
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_bar_NorthAmerica.svg');
...
% Display a single colorbar that applies to all subplots
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_NorthAmerica.svg');
%close all;
save('./grazingniche/matdata/turnover_average_NorthAmerica.mat','compare_turnover_rcp26_average','compare_turnover_rcp45_average','compare_turnover_rcp60_average','compare_turnover_rcp85_average');     
