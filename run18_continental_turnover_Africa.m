...
%% Africa Niche
cond1_pr = (aggregate_pr >= 103 & aggregate_pr <= 2160);
cond1_tas = (aggregate_tas >= 16 & aggregate_tas <= 30);
cond1_sfcWind = (aggregate_sfcWind >= 1.35 & aggregate_sfcWind <= 5);
cond_hurs = (aggregate_hurs >= 38 & aggregate_hurs <= 62);
...
% Data for turnover
data = [
    turnover_continents_average.Africa.rcp26.increase, turnover_continents_average.Africa.rcp26.decrease;
    turnover_continents_average.Africa.rcp45.increase, turnover_continents_average.Africa.rcp45.decrease;
    turnover_continents_average.Africa.rcp60.increase, turnover_continents_average.Africa.rcp60.decrease;
    turnover_continents_average.Africa.rcp85.increase, turnover_continents_average.Africa.rcp85.decrease
];
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_bar_Africa.svg');
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_Africa.svg');
%close all;
save('./grazingniche/matdata/turnover_average_Africa.mat','compare_turnover_rcp26_average','compare_turnover_rcp45_average','compare_turnover_rcp60_average','compare_turnover_rcp85_average');     
