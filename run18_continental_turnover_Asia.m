...
%% Asia Niche
cond1_pr = (aggregate_pr >= 131 & aggregate_pr <= 2643);
cond1_tas = (aggregate_tas >= -4 & aggregate_tas <= 27);
cond1_sfcWind = (aggregate_sfcWind >= 1.3 & aggregate_sfcWind <= 6.3);
cond_hurs = (aggregate_hurs >= 45 & aggregate_hurs <= 66);
...
turnover_Asia_rcp26_average=sum(sum(compare_turnover_rcp26_average(Asiamask==1)));
turnover_increase_Asia_rcp26_average=sum(sum(turnover_increase_rcp26_average((Asiamask==1))))
turnover_decrease_Asia_rcp26_average=sum(sum(turnover_decrease_rcp26_average((Asiamask==1))))

%% Batch making for all continents and all rcps
% Define RCPs and Continents
rcps = {'rcp26', 'rcp45', 'rcp60', 'rcp85'};
continents = {'Asia', 'Europe', 'Oceania', 'Asia', 'NorthAmerica', 'SouthAmerica'};
...
%save('./grazingniche/matdata/turnover_continents_average.mat','turnover_decrease_Asia_rcp26_average')
%% Creat figures
...
% Data for turnover
data = [
    turnover_continents_average.Asia.rcp26.increase, turnover_continents_average.Asia.rcp26.decrease;
    turnover_continents_average.Asia.rcp45.increase, turnover_continents_average.Asia.rcp45.decrease;
    turnover_continents_average.Asia.rcp60.increase, turnover_continents_average.Asia.rcp60.decrease;
    turnover_continents_average.Asia.rcp85.increase, turnover_continents_average.Asia.rcp85.decrease
];
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_bar_Asia.svg');
...
saveas(gcf, '/Users/lichaohui/Desktop/calculation/grazingniche/figuresnew/turnover_allrcp_Asia.svg');
%close all;
save('./grazingniche/matdata/turnover_average_Asia.mat','compare_turnover_rcp26_average','compare_turnover_rcp45_average','compare_turnover_rcp60_average','compare_turnover_rcp85_average');     
